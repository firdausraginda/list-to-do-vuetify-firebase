        ...
        >
          ...
          >
            <v-icon
              ...
              color="success"
            >check_circle</v-icon>
            <v-toolbar-title class="text-xs-center success--text">Done List</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-dialog
              v-model="taskModal"
              persistent
            ...
            >
              ...
              <v-card>
                ...
                <v-card-actions>
                  <v-btn
                    flat
                    @click="editTaskDone(dataTask.namaTask)"
                  >
                    Edit</v-btn>
                  <v-btn
                    flat
...
export default {
  ...
  methods: {
    ...
    saveAddTaskDone() {
      if (this.$refs.formDone.validate()) {
    ...
    closeTaskModal() {
      this.taskModal = false;
      this.$refs.formDone.resetValidation();
      this.$refs.formDone.reset();
    }
  }
};
